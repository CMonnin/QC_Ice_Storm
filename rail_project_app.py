...
app.layout = dbc.Container([
    dbc.Row([
        dbc.Col(children=
            ...
            dcc.Link('Github link', href='https://github.com/CMonnin/Rail_Project'),
    ...
    dbc.Row([
            ...
            dbc.Col(children=[
                html.H3('Conclusion'),
                html.P(children = 
                   ['The GLM model selection went well. Further exploration of hyperparameter tuning would be a logical next step\
    ...
    dbc.Row([
            ...
            html.Cite('[2] MontesinosLopez, Osval A., et al. "Application of a Poisson deep neural network model for the prediction of count data in genome‐based prediction." The Plant Genome 14.3 (2021): e20118.'),
